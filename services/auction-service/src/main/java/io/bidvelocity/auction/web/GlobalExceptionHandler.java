...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<Map<String, Object>> conflict(OptimisticLockingFailureException e, HttpServletRequest req) {
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(body(409, "CONCURRENT_MODIFICATION", "Auction was modified concurrently — retry with fresh state", req));
    }
