...
/**
 * Defense in depth: even though the gateway already validates the JWT, the
 * service verifies the bearer token itself so a direct port-probe cannot
 * impersonate a caller (zero-trust between services).
 */
@Component
